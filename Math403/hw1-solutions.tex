...
\title{Solution}
\linebreak
If p=2, then you get the field with the elements 0 and 1. 2 is a prime
and you can't have a field with less elements, otherwise the 0 and 1 elements wouldn't be distinct.
...
Assume $F$ is finite and its characteristic is a composite,meaning you can write $p$ as multiple of two elements in the field $a$ and $b$ with  
$a<p$ and  $b<p$.
...
\begin{align}
    (a+b)^p=\sum_{k=0}^{p} { p \choose k}a^{p}b^{p-k}
\end{align}
